...
DEFAULT_BITRATE = int(os.environ.get('AIORTC_DEFAULT_BITRATE_OVERRIDE', 1000000))  # 1 Mbps
MIN_BITRATE = int(os.environ.get('AIORTC_MIN_BITRATE_OVERRIDE', 500000))  # 500 kbps
MAX_BITRATE = int(os.environ.get('AIORTC_MAX_BITRATE_OVERRIDE', 3000000))  # 3 Mbps
